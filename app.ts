    ...
    function init() {
        ...
        let getNewTweetColumn = function (mutationsList, columnObserver) {
            ...
            if (drawer !== null) {
                ...
                let iframeObserver = new MutationObserver(getIframeCallback);
        ...
        let columnObserver = new MutationObserver(getNewTweetColumn);
        columnObserver.observe(document.body, config);
    }

    function injectStyleSheetInNewTweetIframe() {
        const newTweetIframe: HTMLIFrameElement = document.querySelector(".r-1yadl64.r-16y2uox");
